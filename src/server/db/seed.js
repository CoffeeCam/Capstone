...
async function createIntialComments(){
    try{
      console.log('Starting to create comments ');
      const comments=[
        { reviewId:1 , creatorId:2, comment: 'demo demo'},
        { reviewId:1 , creatorId:1, comment:'demo demo'},
        { reviewId:1 , creatorId:3, comment:'demo demo'},
        { reviewId:1 , creatorId:4, comment:'demo demo'},
        { reviewId:1 , creatorId:5, comment:'demo demo'},
      ]
      for(const comment of comments){
        await createComments({reviewId:comment.reviewId,creatorId:comment.creatorId,comment:comment.comment});
      }
      console.log('finish creating comments')
    }catch(error){
      throw error;
    }
}
